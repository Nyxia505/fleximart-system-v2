...
class StaffQuotationScreen extends StatefulWidget {
  const StaffQuotationScreen({super.key});

  @override
  State<StaffQuotationScreen> createState() => _StaffQuotationScreenState();
}

class _StaffQuotationScreenState extends State<StaffQuotationScreen>
  ...
  Widget _buildQuotationList(List<Quotation> quotations, String staffId) {
  ...
  void _showQuotationDetails(BuildContext context, Quotation quotation) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => _StaffQuotationDetailsPage(quotation: quotation),
      ),
    );
  }
...
/// Staff Quotation Details Page
/// 
/// Shows quotation details and allows staff to set prices
class _StaffQuotationDetailsPage extends StatefulWidget {
  final Quotation quotation;

  const _StaffQuotationDetailsPage({required this.quotation});

  @override
  State<_StaffQuotationDetailsPage> createState() => _StaffQuotationDetailsPageState();
}

class _StaffQuotationDetailsPageState extends State<_StaffQuotationDetailsPage> {
  final QuotationService _quotationService = QuotationService();
  final FirebaseAuth _auth = FirebaseAuth.instance;
  ...
  Widget build(BuildContext context) {
    ...
    // Group items by productId + length + width
